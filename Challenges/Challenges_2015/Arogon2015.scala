...
//  The weather forecast is described in a zero-indexed array A: for each K (0 ¡Ü K < N), A[K] is equal to 0 if the weather during day K favors the seaside, or 1 if the weather during that day favors the mountains.
//
//Write a function:
